...
import styles from "../../styles/challans.module.css";
        ...
        <div className={styles.pageHeader}>
              <ul className={styles.breadcrumb}>
                <li className={styles.breadcrumb_Item}>
                  <Link className={styles.breadcurmLink} href="/studentPortal">Dashboard</Link>
                </li>
                <FontAwesomeIcon icon={faAngleRight} className={styles.angle}/>
                <li className={styles.breadcrumb_Item}>
                  <Link className={styles.breadcurmLink} href="/studentPortal/challans">Challans</Link>
                </li>
              </ul>
            <p></p>
          </div>
...
export default withAuth(Challans);
